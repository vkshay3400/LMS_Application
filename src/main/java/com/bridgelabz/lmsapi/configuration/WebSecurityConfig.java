...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                "/hired/hiredcandidatedetails","/fellowship/updatedetails","/fellowship/getdetails","/fellowship/count","/hired/sendmail","/hired/onboradstatus","/hired/sendjoboffer" ).permitAll()
